...
public class MutationFrequencyGraph extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ArrayList<Double> list1 = Computation.compute(5, 100, 1000, 10, 1);
		ArrayList<Double> list1a = Computation.compute(5, 100, 1000, 10, 1);
		ArrayList<Double> list1b = Computation.compute(5, 100, 1000, 10, 1);
		ArrayList<Double> list1c = Computation.compute(5, 100, 1000, 10, 1);
		ArrayList<Double> list1d = Computation.compute(5, 100, 1000, 10, 1);
		...
		ArrayList<Double> minFitnessList3 = Computation.compute(5, 100, 1000, 10, 5);
		ArrayList<Double> minFitnessList3a = Computation.compute(5, 100, 1000, 10, 5);
		ArrayList<Double> minFitnessList3b = Computation.compute(5, 100, 1000, 10, 5);
		ArrayList<Double> minFitnessList3c = Computation.compute(5, 100, 1000, 10, 5);
		ArrayList<Double> minFitnessList3d = Computation.compute(5, 100, 1000, 10, 5);
		...
		ArrayList<Double> minFitnessList4 = Computation.compute(5, 100, 1000, 10, 10);
		ArrayList<Double> minFitnessList4a = Computation.compute(5, 100, 1000, 10, 10);
		ArrayList<Double> minFitnessList4b = Computation.compute(5, 100, 1000, 10, 10);
		ArrayList<Double> minFitnessList4c = Computation.compute(5, 100, 1000, 10, 10);
		ArrayList<Double> minFitnessList4d = Computation.compute(5, 100, 1000, 10, 10);
		...
		primaryStage.setTitle("Number of Recombinations");
		final NumberAxis xAxis = new NumberAxis();
		final NumberAxis yAxis = new NumberAxis(17.5, 22.5, 0.5);
		xAxis.setLabel("Generation");
		yAxis.setLabel("Fitness");
		
		final LineChart<Number,Number> lineChart = new LineChart<Number,Number>(xAxis,yAxis);
		lineChart.setTitle("Number of Recombinations");
